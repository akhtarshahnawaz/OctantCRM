    ...
    <table width="100%" class="table table-condensed table-hover table-striped table-bordered">
        ...
        <tr>
            ...
            <td>
                ...
                <div class="btn-group">
                    <a href="<?php echo site_url("home/orders/view");?>/<?php echo $rows['pkey'];?>" class="btn btn-primary btn-mini">view</a>
                    <button class="btn btn-primary btn-mini dropdown-toggle" data-toggle="dropdown">
                        <span class="caret"></span>
                    </button>
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo site_url("home/orders/add");?>/<?php echo $rows['pkey']; ?>">Add</a></li>
                        <!-- dropdown menu links -->
                    </ul>
                </div>
