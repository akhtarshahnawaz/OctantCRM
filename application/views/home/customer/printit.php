...
<html>
<head>
    <title><?php echo $data['od-firstname'].' '.$data['od-lastname']; ?></title>
</head>
<body>

<table align="center" border="1" width="100%" class="table table-condensed table-hover table-striped table-bordered">
