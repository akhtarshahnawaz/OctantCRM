<div class="span8">
    <h3 class="text-info" align="center">Customers</h3>
    ...
    <table width="100%" class="table table-condensed table-hover table-striped table-bordered">
        ...
        <tr>
            ...
            <td>
                ...
                <div class="btn-group">
                    <a href="<?php echo site_url("home/payment/view");?>/<?php echo $rows['pkey'];?>" class="btn btn-primary btn-mini">view</a>
                    <button class="btn btn-primary btn-mini dropdown-toggle" data-toggle="dropdown">
                        <span class="caret"></span>
                    </button>
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo site_url("home/payment/add");?>/<?php echo $rows['pkey']; ?>">Add</a></li>
                        <!-- dropdown menu links -->
                    </ul>
                </div>
